...
**Stack:** `PowerShell` `Excel` `Power BI`
**Impact:** Eliminated manual reporting · 97% data accuracy · Real-time production visibility
...
**Stack:** `Excel` `Power BI` `ACMS`
**Impact:** First system of its kind · Full workforce visibility · Supported team resource planning
